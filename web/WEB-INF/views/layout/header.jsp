    ...
    <div class="menu visible-md visible-lg">
        <ul id="menu">
            <li class="active home-menu"><a href="home"><p><span class="glyphicon glyphicon-home"></span>Home</p></a></li>
            ...
            <li class="contact-menu"><a href="#contact"><p><span class="glyphicon glyphicon-th-list"></span> All Users List</p></a></li>
            <hr>
