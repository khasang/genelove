    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <li><a href="/profiles"><span class="glyphicon glyphicon-user"></span>My profiles</a></li>
                <li><a href="/myProfile">Hello, Dear <strong>${currentUser.firstName} ${currentUser.lastName}</strong></a></li>
